...
//     ref: 'Borrow',          // The model to use for the lookup (Your Borrow model)
//     localField: '_id',      // Find Borrow documents where...
//     foreignField: 'user'    // ...the 'user' field in the Borrow model matches this user's '_id'
// });
...
const userSchema = new mongoose.Schema(
  {
    name: {
      type: String,
      // required: true, // It's better to get name during registration
    },
    email: {
      type: String,
      required: true,
